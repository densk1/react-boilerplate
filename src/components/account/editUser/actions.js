...
export const getUsers = () => async (dispatch) => {
  try {
    const res = await axios.post('/account/users');
...
export const updateUser = (userID, admin) => async (dispatch) => {
  try {
    const res = await axios.post('/account/users/update', { userID, admin });
...
export const deleteUser = (delUserID, index) => async (dispatch) => {
  try {
    const res = await axios.post('/account/users/delete', { delUserID, index });
